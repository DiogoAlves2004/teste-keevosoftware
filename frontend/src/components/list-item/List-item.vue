...
<template>
        ...
        <form @submit.prevent="patch(id)" class="modal-form">
            ...
            <div class="modal-content">
                <div class="modal-left-content">
                    ...
                    <input required type="text" v-model="product.name" class="modal-name"/>

                    <textarea required class="modal-description" name="" id="" cols="30" rows="10" v-model="product.description"></textarea>
    
                    <span class="modal-divisor"></span>
                ...
                <div class="modal-rigth-content">
                    ...
                    <h1 class="modal-quantity"> 
                        ...
                        <h1>Quantidade atual: {{ quantity }}</h1>

                            <h1>Nova qualtidade: </h1><input class="modal-quantity-input" required  v-model="product.quantity" type="number" />  
        

                        
                        <select required v-model="product.metricunit">
    ...
    <li v-show="!sowModal" class="list-item">
        ...
        <h3 class="description">{{ descripition }}</h3>

        <h3 class="quantity">{{ quantity }} &nbsp; - &nbsp; {{ metricUnit }}</h3>

        <button class="edit-button" v-on:click="()=> sowModal = !sowModal">
